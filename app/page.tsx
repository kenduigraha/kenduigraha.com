...
export default function Home() {
  return (
    <>
      ...
      <section className="py-20 px-6 bg-gray-100 text-navy">
        <div className="container mx-auto">
          <h2 className="text-3xl font-bold mb-12 text-center">My Experience</h2>

          <div className="max-w-3xl mx-auto space-y-8">
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-semibold">Stockbit</h3>
              <p className="text-lg font-medium text-gray-700">Sr. Web Engineer</p>
              <p className="text-sm text-gray-500">Oct 2020 - Nov 2023</p>
            </div>

            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-semibold">Bizzy</h3>
              <p className="text-lg font-medium text-gray-700">Fullstack Javascript Engineer</p>
              <p className="text-sm text-gray-500">July 2019 - Jan 2020</p>
            </div>

            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-semibold">Bizzy</h3>
              <p className="text-lg font-medium text-gray-700">Software Development Engineer - Frontend</p>
              <p className="text-sm text-gray-500">Jan 2019 - July 2019</p>
            </div>

            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-semibold">Kudo</h3>
              <p className="text-lg font-medium text-gray-700">Software Engineer - Web</p>
      ...
      <section className="py-16 px-6 text-center">
        ...
        <div className="flex flex-col md:flex-row justify-center gap-8 mt-6">
          <div className="flex flex-col items-center">
            ...
            <a href="mailto:ken.duigraha@gmail.com" className="text-teal hover:underline">
              ken.duigraha@gmail.com
            </a>
          </div>
          <div className="flex flex-col items-center">
            <h3 className="font-semibold mb-2">Phone</h3>
            <a href="tel:+62123456789" className="text-teal hover:underline">
              +62 (0123) 456789
            </a>
          </div>
        </div>
